...
def evaluate_params(params):
    ...
    model = transtab.build_classifier_multi_task(cate_cols, num_cols, bin_cols, imb_weight=params['imb_weight'])
    model = model.to('cuda')
    transtab.train_multi_task(model, train_set, valid_set, **params)
    # print(params)
