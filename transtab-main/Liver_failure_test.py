...
df_train_valid = pd.read_csv('../data_process/TransTab_dataset/Time1_PHLF_train.csv')
df_train_valid = df_train_valid.iloc[:,1:]
df_train, df_valid = train_test_split(df_train_valid, test_size=0.2)
df_test = pd.read_csv('../data_process/TransTab_dataset/Time1_PHLF_test.csv')
df_test = df_test.iloc[:,1:]




X_train, y_train = X_y_split(df_train, info['label'][0])
X_valid, y_valid = X_y_split(df_valid, info['label'][0])
X_test, y_test = X_y_split(df_test, info['label'][0])
...
df_train_valid2 = pd.read_csv('../data_process/TransTab_dataset/Time2_PHLF_train.csv')
...
num_cols = [ 'Age', 'BMI', 'Tumor number',
       'Tumor size', 'Operation time', 'Bleeding',
       'Hemihepatic vascular exclusion', 'Pringle', 'Alpha-fetoprotein',
       'Preoperatively Prothrombin Time',
       'Preoperatively International Normalized Ratio',
       'Preoperatively White Blood Cells', 'Preoperatively Lymphocytes',
       'Preoperatively Neutrophils', 'Preoperatively Red Blood Cells',
       'Preoperatively Hemoglobin ', 'Preoperatively Platelets',
       'Preoperatively Alanine Aminotransferase ',
       'Preoperatively Aspartate Aminotransferase ',
       'Preoperatively Total Protein', 'Preoperatively Albumin',
       'Preoperatively Total Bilirubin', 'Preoperatively Direct Bilirubin',
       'Preoperatively Creatinine', 'Preoperatively Potassium',
       'Preoperatively Sodium', 'First postoperative day Prothrombin Time',
       'First postoperative day International Normalized Ratio',
       'First postoperative day White Blood Cells',
       'First postoperative day Lymphocytes',
       'First postoperative day Neutrophils',
       'First postoperative day Red Blood Cells',
       'First postoperative day Hemoglobin',
       'First postoperative day Platelets',
       'First postoperative day Alanine Aminotransferase',
       'First postoperative day Aspartate Aminotransferase',
       'First postoperative day Total Protein',
       'First postoperative day Albumin',
       'First postoperative day Total Bilirubin',
       'First postoperative day Direct Bilirubin',
       'First postoperative day Creatinine',
       'First postoperative day Potassium', 'First postoperative day Sodium']

# bin_cols = info['bin_col']
bin_cols = ['Hepatitis B', 'Hypertension',
       'Diabetes', 'Cirrhosis', 'Portal hypertension', 'Ascites',
       'Hepatitis B surface Antigen', 'HCV', 'Major', 'Transfusion',
...
training_arguments = {
    ...
    'output_dir':'./checkpoint/LF_bio_240425_6'
}
