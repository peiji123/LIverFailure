...
df_train_valid = pd.read_csv('../data_process/TransTab_dataset/Time1_PHLF_DropLiver_0508_train.csv')
df_train_valid = df_train_valid.iloc[:,1:]
df_train, df_valid = train_test_split(df_train_valid, test_size=0.2)
df_test = pd.read_csv('../data_process/TransTab_dataset/Time1_PHLF_DropLiver_0508_test.csv')
...
df_train_valid2 = pd.read_csv('../data_process/TransTab_dataset/Time2_PHLF_DropLiver_0508_train.csv')
...
training_arguments = {
    ...
    'output_dir':'./checkpoint/LF_bio_240531_06'
}
